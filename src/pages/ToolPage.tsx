...
const ToolPage = () => {
  ...
  useEffect(() => {
    // Enhanced slug matching - try exact ID match first
        ...
        <html>
          <head>
            ...
            <style>
              ...
              @media print { body { margin: 0; } .print-header { page-break-inside: avoid; } .logo-img { -webkit-print-color-adjust: exact; print-color-adjust: exact; } }
            </style>
          </head>
          <body>
            ...
            <div className="p-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:justify-between">
                ...
                <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                  <Button variant="outline" onClick={handlePrintResults} className="w-full sm:w-auto flex items-center space-x-2">
